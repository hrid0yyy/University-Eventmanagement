...
<body> 
  ...
  $oid = $_GET["oid"];
    ...
    <h3 class="page-header">Sponsers</h3>
    </div>
    <br><br>
  ...
  <?php
       ...
       $que = "SELECT * FROM `sponsors` WHERE 1";
       $res = mysqli_query($conn,$que);
       while($row = mysqli_fetch_assoc($res))
       {
          echo "<tr>
          <th scope='row'><img src='./image/". $row['SponsorFileLogo'] ."' width='45px' height='35px' style='border-radius: 50%;' ></th>
          <td>". $row['SponsorID'] . "</td>
          <td>".$row['SponsorName']."</td>
          <td>".$row['SponsorEmail']."</td>
          <td>".$row['SponsorContactNumber']."</td>
