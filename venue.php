...
<body> 
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto">Venues</a></h1>
      </div>
  ...
  <?php
       ...
       $que = "SELECT * FROM `venue_` WHERE 1";
       $res = mysqli_query($conn,$que);
       while($row = mysqli_fetch_assoc($res))
       {
          echo "<tr>
          <th scope='row'><img src='./image/". $row['VenueFileimg'] ."' width='200px' height='150px' ' ></th>
          <td>". $row['VenueName'] . "</td>
          <td>".$row['VenueLocation']."</td>
         <td><a href='addslot.php?vid=".$row['VenueID']."' >Slot</a></td>
