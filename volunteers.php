...
<body> 
  ...
  <?php
       ...
       $que = "SELECT EventName,VolunteerName,VolunteerEmail,VolunteerContactNumber,VolunteerDesignation
       ...
       while($row = mysqli_fetch_assoc($res))
       {
          ...
          <td>".$row['VolunteerEmail']."</td>
          <td>".$row['VolunteerContactNumber']."</td>
          <td>".$row['VolunteerDesignation']."</td>
